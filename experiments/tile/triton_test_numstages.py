...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_vals=['triton2', 'triton1'],
        # Label name for the lines
        line_names=["triton2", "triton1"],
        # Line styles
        styles=[('green', '-'), ('blue', '-')],
...
def benchmark(M, N, K, provider):
    ...
    if provider == 'triton2':
        ms, min_ms, max_ms = triton.testing.do_bench(lambda: matmul2(a, b))
    if provider == 'triton1':
        ms, min_ms, max_ms = triton.testing.do_bench(lambda: matmul1(a, b))
