...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_vals=['torch_naive', 'triton_fused'],
        # Label name for the lines
        line_names=['torch_naive', 'triton_fused'],
        # Line styles
        styles=[('green', '-'), ('blue', '-')],
...
def benchmark(D, provider):
    ...
    if provider == 'triton_fused':
        ms, min_ms, max_ms = triton.testing.do_bench(lambda: fused_mlp(a, w1, w2, False), quantiles=quantiles)
