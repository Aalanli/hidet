...
class ArithExprRewriter(IRRewriter):
    def __init__(self):
        super().__init__()
...
class ConvertArithmaticExpressions(TileFunctionPass):
    def process_tile_func(self, func: Function) -> Function:
        rewriter = ArithExprRewriter()
        return rewriter.visit(func)


def convert_arith_expr_pass() -> TileFunctionPass:
    return ConvertArithmaticExpressions()
